...
As you see, with a simple array of boxes and lines we can ilustrate a logical flow of data where an `input` is affected by a `System` and then converted into an `output`. 
